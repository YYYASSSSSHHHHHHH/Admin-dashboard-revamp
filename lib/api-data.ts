...
import type { MembershipPlanCatalog } from '@/lib/plan-catalog';
...
export const plans: MembershipPlanCatalog[] = [
  {
    id: 'tk-lite',
    name: 'TK-LITE',
    price: 0,
  ...
  },
  {
    ...
    dailyDirectEmail: '3',
    features: [
      { key: 'Daily Broadcast', type: 'value', value: '10' },
      { key: 'Daily Direct Email', type: 'value', value: '3' },
      ...DEFAULT_PLAN_PERMISSIONS.map((p) => ({ ...p })),
    ],
  },
  {
    id: 'growth',
    ...
    dailyDirectEmail: '10',
    features: [
      { key: 'Daily Broadcast', type: 'value', value: '25' },
      { key: 'Daily Direct Email', type: 'value', value: '10' },
      { key: 'Send to all', type: 'yes', value: '' },
      { key: 'State', type: 'yes', value: '' },
      { key: 'City', type: 'yes', value: '' },
      { key: 'Add Contacts', type: 'yes', value: '' },
      { key: 'Address Book', type: 'yes', value: '' },
      { key: 'Phone no (Show / Hide)', type: 'yes', value: '' },
    ],
  },
  {
    ...
    features: [
      ...
      { key: 'Daily Direct Email', type: 'value', value: '20' },
...
export const broadcasts = [
  // Pending broadcasts for approval queue
  { id: 'BR-1015', at: '2026-05-27T09:45:00.000Z', sender: 'Sarah Jenkins', companyName: 'Apex Data', type: 'WTB', condition: 'New', mainCategory: 'Electronics', subCategory: 'Monitors', text: 'Seeking 50 units of 27" 4K monitors for enterprise deployment.', qty: 50, unit: 'Pcs', priceOption: 'Quote', priceAmount: 0, sendingOption: 'SendToAll', audience: 'All Members', status: 'Pending' },
  { id: 'BR-1014', at: '2026-05-27T08:30:00.000Z', sender: 'Yuki Tanaka', companyName: 'Nippon Media', type: 'WTS', condition: 'New', mainCategory: 'Mobile', subCategory: 'Samsung Galaxy', text: 'Bulk Samsung Galaxy S24 Ultra units available, sealed boxes.', qty: 200, unit: 'Pcs', priceOption: 'Fixed', priceAmount: 899, sendingOption: 'SendToAll', audience: 'All Members', status: 'Pending' },
  { id: 'BR-1013', at: '2026-05-26T16:20:00.000Z', sender: 'Liam O\'Connor', companyName: 'Emerald Tech', type: 'WTB', condition: 'New', mainCategory: 'Accessories', subCategory: 'Cables', text: 'Need 500 USB-C to Lightning cables, MFi certified only.', qty: 500, unit: 'Pcs', priceOption: 'Quote', priceAmount: 0, sendingOption: 'SendToGroup', audience: 'Charger suppliers', status: 'Pending' },
  { id: 'BR-1012', at: '2026-05-26T14:15:00.000Z', sender: 'Chloe Dupont', companyName: 'Atelier Design', type: 'WTS', condition: 'Used', mainCategory: 'Electronics', subCategory: 'Keyboards', text: 'Refurbished mechanical keyboards, Cherry MX switches, Grade A.', qty: 75, unit: 'Pcs', priceOption: 'Fixed', priceAmount: 45, sendingOption: 'SendToAll', audience: 'All Members', status: 'Pending' },
  { id: 'BR-1011', at: '2026-05-26T11:00:00.000Z', sender: 'Noah Al-Fayed', companyName: 'Crescent Trading', type: 'WTB', condition: 'New', mainCategory: 'Mobile', subCategory: 'Google Pixel', text: 'Looking for Pixel 8 Pro units, minimum 100 pieces.', qty: 100, unit: 'Pcs', priceOption: 'Quote', priceAmount: 0, sendingOption: 'SendToGroup', audience: 'Mobile buyers', status: 'Pending' },
  { id: 'BR-1010', at: '2026-05-25T17:30:00.000Z', sender: 'Hana Okonkwo', companyName: 'Looplane Studio', type: 'WTS', condition: 'New', mainCategory: 'Accessories', subCategory: 'Cases', text: 'Premium leather cases for iPhone 15 series, bulk pricing available.', qty: 300, unit: 'Pcs', priceOption: 'Fixed', priceAmount: 25, sendingOption: 'SendToAll', audience: 'All Members', status: 'Pending' },
  // Approved/Processed broadcasts
...
export const fieldSettings: Record<string, any[]> = {
  ...
  uom: [
    { id: 'UOM-01', name: 'Pcs', status: 'Active', updatedOn: '2026-05-10T09:00:00.000Z' },
    { id: 'UOM-02', name: 'Kg', status: 'Active', updatedOn: '2026-05-12T09:00:00.000Z' },
    { id: 'UOM-03', name: 'MT', status: 'Inactive', updatedOn: '2026-04-28T09:00:00.000Z' },
  ],
  designation: [
    { id: 'DES-01', name: 'Owner', status: 'Active', updatedOn: '2026-05-08T09:00:00.000Z' },
    { id: 'DES-02', name: 'Operations Manager', status: 'Active', updatedOn: '2026-05-14T09:00:00.000Z' },
    { id: 'DES-03', name: 'Billing / Accounts', status: 'Active', updatedOn: '2026-05-16T09:00:00.000Z' },
  ],
  'inactive-status': [
    { id: 'INA-01', name: 'Payment Failure', status: 'Active', updatedOn: '2026-05-05T09:00:00.000Z' },
    { id: 'INA-02', name: 'Voluntary Pause', status: 'Active', updatedOn: '2026-05-11T09:00:00.000Z' },
  ],
  'business-type': [
    { id: 'BUS-01', name: 'Distributor', status: 'Active', updatedOn: '2026-05-07T09:00:00.000Z' },
    { id: 'BUS-02', name: 'Retailer', status: 'Active', updatedOn: '2026-05-13T09:00:00.000Z' },
    { id: 'BUS-03', name: 'Manufacturer', status: 'Inactive', updatedOn: '2026-04-20T09:00:00.000Z' },
  ],
  'address-title': [
    { id: 'ADR-01', name: 'Company Address', status: 'Active', updatedOn: '2026-05-09T09:00:00.000Z' },
    { id: 'ADR-02', name: 'Warehouse', status: 'Active', updatedOn: '2026-05-15T09:00:00.000Z' },
  ],
...
export function getMemberDetail(memberId: string) {
  ...
  return {
    ...
    contacts: [
      {
        id: 'primary',
        firstName: member.name.split(' ')[0] || 'Aria',
        lastName: member.name.split(' ').slice(1).join(' ') || 'Lindqvist',
        designation: 'owner',
        mobile: member.mobileNumber,
        email: member.email,
        status: 'active',
        photo: `${(member.name.split(' ')[0] || 'A')[0].toUpperCase()}${(member.name.split(' ')[1] || 'L')[0].toUpperCase()}`,
        isMain: true,
      }
    ],
    addresses: [
      {
        ...
        city: member.location.split(',')[0].trim(),
        state: member.location.split(',')[1]?.trim() || 'Stockholm',
        country: 'in',
        pinCode: '400001',
        isDefault: true,
      }
    ...
    timeline: [
      { id: 1, type: 'plan_assigned', title: 'Plan assigned', description: `${plan.name} plan activated`, at: '2026-05-01T09:30:00.000Z', actor: 'Admin' },
      { id: 2, type: 'invoice_generated', title: 'Final invoice generated', description: `Invoice generated for ${plan.name} membership cycle`, at: '2026-05-01T09:34:00.000Z', actor: 'Olivia Chen' },
      { id: 3, type: 'payment_received', title: 'Payment received', description: `Membership payment recorded for ${member.companyName}`, at: '2026-05-02T11:15:00.000Z', actor: 'Olivia Chen' },
      { id: 4, type: 'plan_extended', title: 'Plan extended', description: 'Validity extended by 30 days after renewal confirmation', at: '2026-05-12T14:20:00.000Z', actor: 'Jayesh Jain' },
      { id: 5, type: 'invoice_generated', title: 'Proforma invoice generated', description: 'Draft renewal invoice prepared for upcoming billing cycle', at: '2026-05-18T10:05:00.000Z', actor: 'Admin' },
    ],
    invoices: [
      ...invoices.filter((invoice) => invoice.companyName === member.companyName).map((invoice) => ({
        id: invoice.invoiceNumber,
        invoiceNumber: invoice.invoiceNumber,
        amount: Number(invoice.billingAmount.replace(/[^0-9.]/g, '')),
        type: 'final' as const,
        status: invoice.status.toLowerCase() === 'unpaid' ? 'pending' : invoice.status.toLowerCase(),
        issuedAt: '2026-04-28T00:00:00.000Z',
        dueDate: '2026-06-03T09:30:00.000Z',
        planName: `TK-${invoice.associatedPlan}`,
        validityStart: invoice.validityStart,
        validityEnd: invoice.validityEnd,
        bankName: invoice.settlementDetails?.recipientBank,
        bankRef: invoice.settlementDetails?.referenceNumber,
        paidOn: invoice.settlementDetails?.settlementDate,
      })),
      {
        id: 'ISPL/1997/2025-26',
        invoiceNumber: 'ISPL/1997/2025-26',
        amount: 1500,
        type: 'final' as const,
        status: 'paid',
        ...
        planName: 'TK-Lite',
        validityStart: '12-Feb-2026',
        validityEnd: '12-Mar-2027',
        bankName: 'HDFC Bank',
        bankRef: 'TXN-7348201',
        paidOn: '2026-02-14T00:00:00.000Z',
      },
      {
        id: `PRO-${member.id.slice(0, 3).toUpperCase()}-3101`,
        invoiceNumber: `PRO-${member.id.slice(0, 3).toUpperCase()}-3101`,
        amount: plan.price,
        type: 'proforma' as const,
        status: 'draft',
        issuedAt: '2026-05-18T10:05:00.000Z',
        dueDate: '2026-06-01T10:05:00.000Z',
        planName: `TK-${plan.name}`,
        validityStart: '18-May-2026',
        validityEnd: member.expiryDate || '06-Jun-2026',
      },
      {
        id: `INV-${member.id.slice(0, 3).toUpperCase()}-3024`,
        invoiceNumber: `INV/${member.id.slice(0, 3).toUpperCase()}/3024`,
        amount: plan.price,
        type: 'final' as const,
        status: 'paid',
        issuedAt: '2026-05-01T09:34:00.000Z',
        dueDate: '2026-05-15T09:34:00.000Z',
        planName: `TK-${plan.name}`,
        validityStart: '01-May-2026',
        validityEnd: member.expiryDate || '06-Jun-2026',
        bankName: 'HDFC Bank',
        bankRef: 'TXN-7348201',
        paidOn: '2026-05-02T11:15:00.000Z',
        bankRemark: 'Payment received via bank transfer.',
      },
    ],
    emails: MOCK_EMAILS.filter((email) => email.recipient.email === member.email),
    broadcasts: broadcasts
      .filter((broadcast) => broadcast.companyName === member.companyName)
      .map(toFrontendBroadcast),
    joinIp: '192.168.1.100',
    totalPosts: 1420,
    lastLogin: '2026-05-20T08:15:00.000Z',
    registrationDate: member.registrationDate,
    verified: member.id === 'aria-lindqvist',
