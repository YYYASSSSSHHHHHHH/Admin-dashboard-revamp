...
import { ADDRESS_TITLES, COUNTRIES, STATES_BY_COUNTRY } from "@/data/mockData";
...
const titleLabel = (id) => ADDRESS_TITLES.find((t) => t.id === id)?.label || id;
const countryLabel = (id) => COUNTRIES.find((c) => c.id === id)?.label || id;

export const AddressTab = ({ addresses, onChange }) => {
